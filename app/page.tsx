...
const projects = [
  ...
  { index: '04', title: '加油宝产品与运营视觉', subtitle: 'UI / CAMPAIGN / 2016—2018', tone: 'violet', copy: '从 APP 界面、图标体系到营销闪屏和 H5，统一金融产品的专业感与业务转化体验。', image: '/assets/project-04-brand-cover.png' },
