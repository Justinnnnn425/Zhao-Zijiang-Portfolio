...
const projects = [
  ...
  { index: '03', title: 'UI界面设计', subtitle: 'USER INTERFACE DESIGN', tone: 'lime', copy: '覆盖核心界面与交互场景，以清晰、一致的视觉语言提升产品体验。', image: '/assets/project-03-ui.webp', href: '/projects/ui-interface' },
