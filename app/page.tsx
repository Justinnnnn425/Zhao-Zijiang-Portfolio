...
const projects = [
  ...
  { index: '09', title: '其他物料设计汇总', subtitle: 'OTHER DESIGN MATERIALS COLLECTION', tone: 'lime', copy: '', image: '/assets/project-09-materials.webp', href: '/projects/materials-collection' },
];
